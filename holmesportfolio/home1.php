 ...
 * Description: A theme for holmes
 **/

?>

<!-- wp:heading -->
<h2 class="wp-block-heading">This is the custom homepage content. You can customize it as needed.</h2>
<!-- /wp:heading -->

<!-- wp:columns {"className":"left-home3"} -->
<div class="wp-block-columns left-home3"><!-- wp:column {"style":{"color":{"background":"#ebebeb"}}} -->
	<div class="wp-block-column has-background" style="background-color:#ebebeb"><!-- wp:heading {"textAlign":"center"} -->
...
<!-- wp:columns {"className":"left-home3"} -->
<div class="wp-block-columns left-home3"><!-- wp:column -->
...
<div class="wp-block-columns inline-squares"><!-- wp:column {"style":{"color":{"background":"#ebebeb"}},"className":"square1"} -->
	<div class="wp-block-column square1 has-background" style="background-color:#ebebeb"><!-- wp:image {"id":273,"aspectRatio":"1","scale":"cover","sizeSlug":"medium","linkDestination":"none","className":"is-style-rounded"} -->
		...
		<h2 class="wp-block-heading has-text-align-center"><br>Shop</h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph -->
		<p>Add a image above the title.</p>
		<!-- /wp:paragraph -->

		<!-- wp:paragraph {"align":"center"} -->
		<p class="has-text-align-center"><a href="/contact-us">Shop</a></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:column -->
	...
	<div class="wp-block-column square2"><!-- wp:image {"id":271,"aspectRatio":"1","scale":"cover","sizeSlug":"medium","linkDestination":"none","className":"is-style-rounded"} -->
		...
		<!-- wp:heading {"textAlign":"center"} -->
		<h2 class="wp-block-heading has-text-align-center"><br>Hire us </h2>
		<!-- /wp:heading -->
		...
		<!-- wp:paragraph {"align":"center"} -->
		<p class="has-text-align-center"><a href="/contact-us">Hire us</a></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:column -->
	...
	<div class="wp-block-column square3 has-background" style="background-color:#ebebeb"><!-- wp:image {"id":272,"aspectRatio":"1","scale":"cover","sizeSlug":"medium","linkDestination":"none","className":"is-style-rounded"} -->
		...
		<!-- wp:heading {"textAlign":"center"} -->
		<h2 class="wp-block-heading has-text-align-center"><br>Our products </h2>
		<!-- /wp:heading -->
		...
		<!-- wp:paragraph {"align":"center"} -->
		<p class="has-text-align-center"><a href="/contact-us">Our products</a></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:column -->
	...
	<div class="wp-block-column square4"><!-- wp:image {"id":271,"aspectRatio":"1","scale":"cover","sizeSlug":"medium","linkDestination":"none","className":"is-style-rounded"} -->
		...
		<!-- wp:heading {"textAlign":"center"} -->
		<h2 class="wp-block-heading has-text-align-center"><br>Contact us </h2>
		<!-- /wp:heading -->
		...
		<!-- wp:paragraph {"align":"center"} -->
		<p class="has-text-align-center"><a href="/contact-us">Contact us</a></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:column -->
</div>
